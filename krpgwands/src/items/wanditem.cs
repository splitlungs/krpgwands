...
namespace krpgwands
{
    ...
    public class WandItem : Item
    {
        ...
        public override bool OnHeldInteractStep(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            ...
            {
                EntityPlayer bp = byEntity as EntityPlayer;
                if (bp != null)
                    bp.Player.InventoryManager.BroadcastHotbarSlot();
            ...
            if (byEntity.World is IClientWorldAccessor)
            {
                if (secondsUsed > 0.6)
                {
                    ...
                    particles.AddPos.Set(0.75, -0.25, 0.1);
        ...
        public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            ...
            // Note that we MUST include the mod prefix here, as we're passing this out of namespace
            // EntityProperties type = byEntity.World.GetEntityType(new AssetLocation("krpgwands:magicmissile-" + stack.Collectible.Variant["material"]));
